...
samplelink  = read.table("//me-filer1/home$/am2609/My Documents/Programs/GWAS_inprogress/BB_input/sampleID_map.txt", stringsAsFactors=FALSE, header=TRUE) 



# load outcomes file and list outcomes of interest
outcomes = read.csv("//me-filer1/home$/am2609/My Documents/Stata_outcomes/april_2019_alloutcomes_v2.csv", header=TRUE)
wanted_outcomes<-c( "hpt", "pvd_simple", "ukb_mi", "ukb_stemi", "ukb_nstemi", "ukb_stroke", "ukb_stri", "ukb_ich" ,
                    "ukb_sah"  ,"cad_soft"  ,  "cad_hard" , "cad_int" ,"tia" , "dvt" ,"pe" ,  "aaa" ,"hf" , "dmcp" ,
                    "hf_dmcp" , "ast"  , "af" ,  "ckd" , "taa" ,  "aa" , "hf_cmp" ,"vte" , "ptca_cabg" , "CHD_death" , 
                    "i_stroke_death","ish_hf","sch_1" , "sch_2" ,"aost" , "aost_wide","pe_thm", "ka" , "hfailure", "pad" ,
                    "amputation", "utinf", "ginf", "ckd_j" , "akd","akd_nSR" , "haem", "ischtia", "hfnocad" )
...
# save sample file
write.table(sample_out,"~/Stata_outcomes/cvd.sample", row.names=FALSE, quote=FALSE)
